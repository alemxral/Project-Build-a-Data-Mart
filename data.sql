...
(1 , 'Juan'      , 'Pérez'     , 'u1@demo.com' , '1000000001', NOW(), 'guest'),
(2 , 'Beatriz'   , 'Sánchez'   , 'u2@demo.com' , '1000000002', NOW(), 'guest'),
(3 , 'Carlos'    , 'Díaz'      , 'u3@demo.com' , '1000000003', NOW(), 'guest'),
(4 , 'Diego'     , 'Romero'    , 'u4@demo.com' , '1000000004', NOW(), 'guest'),
(5 , 'Elena'     , 'García'    , 'u5@demo.com' , '1000000005', NOW(), 'guest'),
(6 , 'Francisco' , 'Martín'    , 'u6@demo.com' , '1000000006', NOW(), 'host' ),
(7 , 'Gabriela'  , 'López'     , 'u7@demo.com' , '1000000007', NOW(), 'host' ),
(8 , 'Hugo'      , 'Muñoz'     , 'u8@demo.com' , '1000000008', NOW(), 'host' ),
(9 , 'Inés'      , 'Costa'     , 'u9@demo.com' , '1000000009', NOW(), 'host' ),
(10, 'Jorge'     , 'Nolasco'   , 'u10@demo.com', '1000000010', NOW(), 'host' ),
(11, 'Karla'     , 'Yáñez'     , 'u11@demo.com', '1000000011', NOW(), 'guest'),
(12, 'Luis'      , 'Figueroa'  , 'u12@demo.com', '1000000012', NOW(), 'guest'),
(13, 'María'     , 'Salinas'   , 'u13@demo.com', '1000000013', NOW(), 'guest'),
(14, 'Nicolás'   , 'Gómez'     , 'u14@demo.com', '1000000014', NOW(), 'guest'),
(15, 'Olivia'    , 'Chávez'    , 'u15@demo.com', '1000000015', NOW(), 'guest'),
(16, 'Pablo'     , 'Silva'     , 'u16@demo.com', '1000000016', NOW(), 'guest'),
(17, 'Raquel'    , 'Grau'      , 'u17@demo.com', '1000000017', NOW(), 'guest'),
(18, 'Rodrigo'   , 'Cano'      , 'u18@demo.com', '1000000018', NOW(), 'guest'),
(19, 'Sara'      , 'López'     , 'u19@demo.com', '1000000019', NOW(), 'guest'),
(20, 'Tomás'     , 'Bravo'     , 'u20@demo.com', '1000000020', NOW(), 'guest'),
(21, 'Úrsula'    , 'Soto'      , 'u21@demo.com', '1000000021', NOW(), 'guest'),
(22, 'Víctor'    , 'Navarro'   , 'u22@demo.com', '1000000022', NOW(), 'guest'),
(23, 'Walter'    , 'Huesca'    , 'u23@demo.com', '1000000023', NOW(), 'guest'),
(24, 'Ximena'    , 'Ibáñez'    , 'u24@demo.com', '1000000024', NOW(), 'guest'),
(25, 'Yago'      , 'Pascual'   , 'u25@demo.com', '1000000025', NOW(), 'guest'),
(26, 'Zacarías'  , 'Ibarra'    , 'u26@demo.com', '1000000026', NOW(), 'admin'),
(27, 'Ana'       , 'Ruiz'      , 'u27@demo.com', '1000000027', NOW(), 'admin'),
(28, 'Bruno'     , 'Segovia'   , 'u28@demo.com', '1000000028', NOW(), 'admin'),
(29, 'Carmen'    , 'Luna'      , 'u29@demo.com', '1000000029', NOW(), 'admin'),
(30, 'Daniel'    , 'Olmedo'    , 'u30@demo.com', '1000000030', NOW(), 'admin');
...
(property_id,host_id,title,description,property_type,room_type,address,city,state,country,zipcode,created_at)
VALUES
(1,1,'Listing 1','Desc 1','Apartment','Entire','Addr 1','City 1','St1','CTY','00001',NOW()),
(2,2,'Listing 2','Desc 2','Apartment','Entire','Addr 2','City 2','St2','CTY','00002',NOW()),
(3,3,'Listing 3','Desc 3','Apartment','Private','Addr 3','City 3','St3','CTY','00003',NOW()),
(4,4,'Listing 4','Desc 4','House','Entire','Addr 4','City 4','St4','CTY','00004',NOW()),
(5,5,'Listing 5','Desc 5','House','Entire','Addr 5','City 5','St5','CTY','00005',NOW()),
(6,6,'Listing 6','Desc 6','Loft','Entire','Addr 6','City 6','St6','CTY','00006',NOW()),
(7,7,'Listing 7','Desc 7','Loft','Private','Addr 7','City 7','St7','CTY','00007',NOW()),
(8,8,'Listing 8','Desc 8','Villa','Entire','Addr 8','City 8','St8','CTY','00008',NOW()),
(9,9,'Listing 9','Desc 9','Villa','Entire','Addr 9','City 9','St9','CTY','00009',NOW()),
(10,10,'Listing 10','Desc 10','Cabin','Entire','Addr 10','City 10','St10','CTY','00010',NOW()),
(11,1,'Listing 11','Desc 11','Cabin','Entire','Addr 11','City 11','St11','CTY','00011',NOW()),
(12,2,'Listing 12','Desc 12','Flat','Entire','Addr 12','City 12','St12','CTY','00012',NOW()),
(13,3,'Listing 13','Desc 13','Flat','Private','Addr 13','City 13','St13','CTY','00013',NOW()),
(14,4,'Listing 14','Desc 14','Studio','Entire','Addr 14','City 14','St14','CTY','00014',NOW()),
(15,5,'Listing 15','Desc 15','Studio','Entire','Addr 15','City 15','St15','CTY','00015',NOW()),
(16,6,'Listing 16','Desc 16','BnB','Entire','Addr 16','City 16','St16','CTY','00016',NOW()),
(17,7,'Listing 17','Desc 17','BnB','Private','Addr 17','City 17','St17','CTY','00017',NOW()),
(18,8,'Listing 18','Desc 18','Resort','Entire','Addr 18','City 18','St18','CTY','00018',NOW()),
(19,9,'Listing 19','Desc 19','Resort','Entire','Addr 19','City 19','St19','CTY','00019',NOW()),
(20,10,'Listing 20','Desc 20','Resort','Entire','Addr 20','City 20','St20','CTY','00020',NOW());
...
(1,1,1,6,'Hi, excited for my stay!',NOW()),
(2,1,6,1,'Thanks, see you soon!',NOW()),
(3,2,2,7,'Can I get early check‑in?',NOW()),
(4,2,7,2,'Sure, no problem',NOW()),
(5,3,3,8,'Is parking available?',NOW()),
(6,3,8,3,'Yes, free on site',NOW()),
(7,4,4,9,'Any restaurants nearby?',NOW()),
(8,5,5,10,'Do you allow pets?',NOW()),
(9,5,10,5,'Sorry, no pets',NOW()),
(10,6,6,11,'I need to cancel',NOW()),
(11,7,7,12,'Wifi speed?',NOW()),
(12,8,8,13,'Looking forward!',NOW()),
(13,9,9,14,'Noise level?',NOW()),
(14,10,10,15,'Extra towels please',NOW()),
(15,11,11,1,'Is the pool open?',NOW()),
(16,12,12,2,'Heating working?',NOW()),
(17,13,13,3,'Left my keys',NOW()),
(18,14,14,4,'Late checkout?',NOW()),
(19,15,15,5,'Great host!',NOW()),
(20,16,16,6,'Thanks for staying',NOW());

/* 16. property_reviews (20) */
INSERT INTO property_reviews
(review_id,property_id,guest_id,rating,comment,review_date) VALUES
(1,1,1,95,'Awesome stay','2025-01-12'),
(2,2,2,88,'Great place','2025-01-15'),
(3,3,3,80,'Good','2025-01-16'),
(4,4,4,92,'Loved it','2025-01-20'),
(5,5,5,85,'Nice pool','2025-01-22'),
(6,6,6,78,'Okay','2025-01-25'),
(7,7,7,90,'Fantastic','2025-01-28'),
(8,8,8,94,'Beach wow','2025-02-02'),
(9,9,9,70,'Small rooms','2025-02-05'),
(10,10,10,88,'Convenient','2025-02-07'),
(11,11,11,96,'Super clean','2025-02-10'),
(12,12,12,82,'Good price','2025-02-12'),
(13,13,13,84,'Cozy','2025-02-15'),
(14,14,14,97,'Perfect','2025-02-18'),
(15,15,15,76,'Basic','2025-02-20'),
(16,16,16,91,'Amazing view','2025-02-24'),
(17,17,17,99,'Will return','2025-02-28'),
(18,18,18,68,'Could improve','2025-03-01'),
(19,19,19,86,'Nice decor','2025-03-04'),
(20,20,20,98,'Best stay','2025-03-06');
